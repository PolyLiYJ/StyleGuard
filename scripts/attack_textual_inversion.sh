...
# accelerate launch --gpu_ids="5,6" --num_processes=2 --config_file gpu_config.yaml --main_process_port=8888 /home/yjli/AIGC/diffusers/SimAC/diffusers/examples/textual_inversion/textual_inversion.py \
...
python /home/yjli/AIGC/diffusers/SimAC/infer_textural_inversion.py \
    --model_path "stable-diffusion-v1-5/stable-diffusion-v1-5" \
    --embedding_path "/home/yjli/AIGC/diffusers/SimAC/dreambooth-outputs/anti-style/test_textual_inversion" \
    --prompt " a <sks-style> paint of house" \
    --placeholder_token "<sks-style>" \
    --num_images 8 \
    --output_dir "/home/yjli/AIGC/diffusers/SimAC/dreambooth-outputs/anti-style/test_textual_inversion/image"
...
python evaluate/eval_fid_new.py \
  --input_folder "/home/yjli/AIGC/diffusers/SimAC/dreambooth-outputs/anti-style/test_textual_inversion/image" \
...
python evaluate/eval_precision_new.py \
  ...
  --gen_folder "/home/yjli/AIGC/diffusers/SimAC/dreambooth-outputs/anti-style/test_textual_inversion/image/"
