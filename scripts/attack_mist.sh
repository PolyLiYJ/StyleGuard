...
export OUTPUT_DIR="/home/yjli/AIGC/diffusers/SimAC/outputs/$EXPERIMENT_NAME"
...
export INSTANCE_DIR="$OUTPUT_DIR/vangogh_16_200_512_1_2_1_0_1"
...
export EXPERIMENT_NAME="mist_upscale"
