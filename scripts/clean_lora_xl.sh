...
export EXPERIMENT_NAME="test_lora_XL_clean"
...
export OUTPUT_DIR="/home/yjli/AIGC/diffusers/SimAC/outputs/style/wikiart/test_lora"
...
# accelerate launch --num_processes=2 --gpu_ids="0,1,2,3,4" --config_file gpu_config.yaml --main_process_port=8831 /home/yjli/AIGC/diffusers/examples/dreambooth/train_dreambooth_lora_sdxl.py \
...
python infer_lora.py \
    --model_path $MODEL_PATH \
    --lora_path "$DREAMBOOTH_OUTPUT_DIR/pytorch_lora_weights.safetensors" \
    --prompt "an painting, including a house" \
    --v "sks" \
    --img_num 8 \
...
#   --input_folder "/home/yjli/AIGC/diffusers/SimAC/evaluate/test_lora_xl/" \
...
#   --gen_folder "/home/yjli/AIGC/diffusers/SimAC/evaluate/test_lora_xl/"
