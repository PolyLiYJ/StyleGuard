...
export EXPERIMENT_NAME="test_lora_clean"
...
# accelerate launch --num_processes=2 --gpu_ids="1,2" --config_file gpu_config.yaml --main_process_port=8830  attacks/ensemble_aspl.py \
...
export INSTANCE_DIR='/home/yjli/AIGC/diffusers/Gogh_House/Gogh_House_SD1_5'
# export INSTANCE_DIR="/home/yjli/AIGC/diffusers/image_van_gogh_small" 
...
accelerate launch --num_processes=2 --gpu_ids="0,1,2,3,4" --config_file gpu_config.yaml --main_process_port=8830 /home/yjli/AIGC/diffusers/examples/dreambooth/train_dreambooth_lora.py \
...
#     --lora_path "/home/yjli/AIGC/diffusers/SimAC/dreambooth-outputs/anti-style/test_lora/pytorch_lora_weights.safetensors" \
#     --prompt "an sks painting, including a basket and some apples"
#     --v "sks" \
#     --img_num 8 \
#     --output_dir "/home/yjli/AIGC/diffusers/SimAC/dreambooth-outputs/anti-style/test_lora"
...
#   --input_folder "/home/yjli/AIGC/diffusers/SimAC/evaluate/test_lora/an_sks_painting_including_a_house" \
...
#   --gen_folder "/home/yjli/AIGC/diffusers/SimAC/evaluate/test_lora/an_sks_painting_including_a_house"
...
# accelerate launch --num_processes=2 --gpu_ids="0,1" --config_file gpu_config.yaml --main_process_port=8830 /home/yjli/AIGC/diffusers/examples/dreambooth/train_dreambooth.py \
#   --pretrained_model_name_or_path=$MODEL_PATH  \
#   --enable_xformers_memory_efficient_attention \
#   --train_text_encoder \
#   --instance_data_dir=$INSTANCE_DIR \
