...
export CLEAN_TRAIN_DIR="/home/yjli/AIGC/diffusers/SimAC/CelebA-HQ/103/all" 
export CLEAN_ADV_DIR="/home/yjli/AIGC/diffusers/SimAC/CelebA-HQ/103/all"
export OUTPUT_DIR="/home/yjli/AIGC/diffusers/SimAC/outputs/style/celeba/$EXPERIMENT_NAME"
export CLASS_DIR="/home/yjli/AIGC/diffusers/SimAC/clean_class_image"
...
export INSTANCE_DIR="/home/yjli/AIGC/diffusers/SimAC/CelebA-HQ/103/all"
# export DREAMBOOTH_OUTPUT_DIR="dreambooth-outputs/simac/CelebA-HQ/$EXPERIMENT_NAME"
export DREAMBOOTH_OUTPUT_DIR="/home/yjli/AIGC/diffusers/SimAC/dreambooth-outputs/clean/$EXPERIMENT_NAME"
...
#   --instance_prompt="a person of sks" \
...
#   --prompt "a person of sks, wearing a sunglass"

# python infer.py \
#   --model_path $DREAMBOOTH_OUTPUT_DIR \
#   --output_dir $OUTPUT_DIR/checkpoint-1000-test-infer \
#   --prompt "a person, wearing a sunglass"
...
export MODEL_PATH="CompVis/stable-diffusion-v1-4"
# # export OUTPUT_DIR="model/saved_model_vangogh_addnoise"
export INSTANCE_DIR="$OUTPUT_DIR/noise-upscale"
...
python infer.py \
  ...
  --prompt "an person of sks, wearing a sunglass"
...
# export EXPERIMENT_NAME="face_upscale"
