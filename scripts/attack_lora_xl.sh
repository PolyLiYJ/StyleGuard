...
export EXPERIMENT_NAME="test_lora_XL"
...
# accelerate launch --num_processes=2 --gpu_ids="0,1,2,3,4" --config_file gpu_config.yaml --main_process_port=8830 /home/yjli/AIGC/diffusers/examples/dreambooth/train_dreambooth_lora_sdxl.py \
